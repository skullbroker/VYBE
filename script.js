...
var defaultContent = [
    ...
    {
        id: 9,
        title: "Teliseney Naa Nuvvey",
        category: "Creators",
        creator: "Student Stories Co.",
        image: "https://drive.google.com/file/d/13bajD9Ftjt56oFubjYi8JlX3ynThi9rW/view?usp=sharing",
        description: "A short cinematic story created by young filmmakers.",
        duration: "14m",
        year: 2024,
        video: "https://drive.google.com/file/d/1dpybatArR4fsBcRnLpwIZxt7epXMbnv-/view?usp=sharing",
        trailer: "https://drive.google.com/file/d/1RvqGW58puGRwar7aBC42Kcx-5R9h3vcV/view?usp=sharing"
    },
    {
        id: 10,
...
/* Patches content already saved in localStorage from an earlier version
   of this app (e.g. before trailers existed) with any new fields the
   matching seed item now has — trailer, duration, year — without
   touching content an admin added or edited themselves. */
function migrateStoredContent() {
    ...
    var patched = stored.map(function (item) {
        ...
        ["trailer", "duration", "year"].forEach(function (key) {
            if ((next[key] === undefined || next[key] === null) && seed[key] !== undefined) {
    ...
    if (changed) saveContent(patched);
}
...
$("contentForm").addEventListener("submit", function (event) {
    ...
    if (trailer && !extractYouTubeId(trailer)) {
        setMessage(adminMessage, "The trailer URL should be a YouTube link (watch, youtu.be or embed).", "error");
        return;
    }
